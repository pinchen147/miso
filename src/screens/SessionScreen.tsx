...
export default function SessionScreen({ navigation, route }: Props) {
  ...
  if (!permission.granted) {
    return (
      <View style={styles.container}>
        <Text style={styles.permissionText}>Camera access is needed for the cooking session</Text>
          ...
          <View style={styles.controls}>
            ...
            {isListening && (
              <Animated.View style={[styles.listeningIndicator, { opacity: pulseAnim }]}>
                <Text style={styles.listeningText}>AI Assistant is listening...</Text>
              </Animated.View>
            )}
            ...
            <Text style={styles.recipeInfo}>Cooking: {recipeName}</Text>
          </View>
        </View>
      </CameraView>
    </View>
